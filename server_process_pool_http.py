...
from httpserver import HttpServer  # pastikan file ini bernama httpserver.py

httpserver = HttpServer()

def ProcessTheClient(connection, address):
    """Process client request and send the response"""
    try:
        buffer = b""
        while b"\r\n\r\n" not in buffer:
        ...
        result = httpserver.proses(request_str)
        result += b"\r\n\r\n"
...
def Server():
    ...
    with ProcessPoolExecutor(20) as executor:
        while True:
            ...
            the_clients.append(p)  # ✅ FIXED HERE
            active_processes = [i for i in the_clients if not i.done()]
