...
from httpserver import HttpServer  # pastikan httpserver.py ada
...
def Server():
    ...
    my_socket.listen(10)
    print("Thread Pool HTTP Server listening on port 8889...")
    ...
    with ThreadPoolExecutor(max_workers=20) as executor:
        while True:
            ...
            active_threads = [i for i in the_clients if not i.done()]
